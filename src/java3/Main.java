...
public class Main {
    ...
    public static void main(String[] args) {
        //ни каким образом не получается убрать "пишите здесь свой код" потому что изначально когда расшаривал проект здесь
        //кинул просто пустой и видимо когда сейчас комит и пуш другой ветки сделал и они почемут то слились хотя в редактирование файла нельхя убрать 
        //ни надпись ни ковычку в конце этого файла
